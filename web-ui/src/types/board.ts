import type { RuntimeBoardColumnId, RuntimeTaskAutoReviewMode, RuntimeTaskImage, RuntimeTaskSchedule } from "@/runtime/types";
...
export type TaskSchedule = RuntimeTaskSchedule;
