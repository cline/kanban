...
export default function App(): ReactElement {
	...
	useAppHotkeys({
		...
		handleOpenFileSearch: hasNoProjects || isAllProjectsHomeView ? undefined : handleOpenFileSearch,
		handleToggleCodeBrowser: hasNoProjects || isAllProjectsHomeView ? undefined : handleToggleCodeBrowser,
	});
			...
			<div className="flex h-[100svh] min-w-0 overflow-hidden">
				...
				<div className="flex flex-col flex-1 min-w-0 overflow-hidden">
					<TopBar
						...
						onToggleCodeBrowser={
							!selectedCard && !hasNoProjects && !isAllProjectsHomeView ? handleToggleCodeBrowser : undefined
						}
						isCodeBrowserOpen={isCodeBrowserOpen}
						onOpenFileSearch={
							!selectedCard && !hasNoProjects && !isAllProjectsHomeView ? handleOpenFileSearch : undefined
						}
