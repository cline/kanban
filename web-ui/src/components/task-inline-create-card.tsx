...
export function TaskInlineCreateCard({
	...
	const actionLabel = mode === "edit" ? t("common.save") : t("task.create");
	...
	const cancelLabel = hideCancelShortcut ? t("common.cancel") : t("common.cancelEsc");
		...
		>
				...
				{onTitleChange ? (
					<div className="mb-2">
						...
						<input
							...
							placeholder={deriveTaskTitleFromPrompt(prompt) || t("task.autoGeneratedFromPrompt")}
			...
			<div className="flex flex-col gap-2 mt-3">
				...
				>
					<RadixCheckbox.Root
						id={planModeId}
						aria-label={t("task.startInPlanMode")}
					...
					<span>{t("task.startInPlanMode")}</span>
				</label>
				...
				<div className="flex items-center gap-2 flex-wrap">
					...
					>
						<RadixCheckbox.Root
							...
							aria-label={t("task.enableAutoReview")}
						...
						<span>{t("task.automatically")}</span>
					</label>
					<NativeSelect
						id={autoReviewModeId}
						size="sm"
